...
class AutoRotationVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        DispatchQueue.main.async {
            self.testImgView.loadGif(name: "Phone_Rotation _Portrait")
        }
            ...
            if UIDevice.current.orientation.isLandscape {
                ...
                if !hasStarted {
                    ...
                    DispatchQueue.main.async {
                        ...
                        self.headingLbl.text = self.getLocalizatioStringValue(key: "Motion Sensor Test")
                        self.headingLbl.font = UIFont.init(name: AppFontBold, size: self.headingLbl.font.pointSize)
                        self.subHeadingLbl.text = self.getLocalizatioStringValue(key: "The system will detect your phone from portrait to landscap view by turning on screen auto-rotation.")
    ...
    func setUIElementsProperties() {
        ...
        self.guideBtn.titleLabel?.font = UIFont.init(name: AppFontSemiBold, size: guideBtnFontSize ?? 18.0)
        ...
        self.startGuideBtn.titleLabel?.font = UIFont.init(name: AppFontBold, size: startGuideBtnFontSize ?? 18.0)
    ...
    @objc func rotated()
    {
        if (UIDevice.current.orientation.isLandscape)
        {
            ...
            self.testImgView.loadGif(name: "Phone_Rotation_Landscape")
            ...
            DispatchQueue.main.async {
                ...
                self.headingLbl.text = self.getLocalizatioStringValue(key: "Motion Sensor Test")
                self.headingLbl.font = UIFont.init(name: AppFontBold, size: self.headingLbl.font.pointSize)
                self.subHeadingLbl.text = self.getLocalizatioStringValue(key: "Please rotate your phone back to vertical.")
                self.subHeadingLbl.font = UIFont.init(name: AppFontSemiBold, size: self.subHeadingLbl.font.pointSize)
            }
