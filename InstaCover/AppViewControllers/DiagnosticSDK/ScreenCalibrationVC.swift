...
class ScreenCalibrationVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        DispatchQueue.main.async {
            ...
            // 1. Speaker
            if arrTestsInSDK.contains("speaker") {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
            ...
            // 2. Vibrator
            if arrTestsInSDK.contains("vibrator") {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 1.0) {
            ...
            // 3. Microphone
            if arrTestsInSDK.contains("microphone") {
                if let ind = arrTestsInSDK.firstIndex(of: ("microphone")) {
                    arrTestsInSDK.remove(at: ind)
    ...
    func setUIElementsProperties() {
        ...
        self.startGuideBtn.titleLabel?.font = UIFont.init(name: AppFontSemiBold, size: startGuideBtnFontSize ?? 18.0)
    ...
    func testTouches(touches: Set<UITouch>) {
        ...
        for (index,obstacleView) in obstacleViews.enumerated() {
            ...
            if obstacleViewFrame.contains(touchLocation!) {
                ...
                levelLayer.fillColor = #colorLiteral(red: 0.4039215686, green: 0.9882352941, blue: 0.9450980392, alpha: 1).cgColor
                // #67FCF1
