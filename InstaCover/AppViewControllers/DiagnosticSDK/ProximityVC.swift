...
class ProximityVC: UIViewController {
    ...
    func setUIElementsProperties() {
        ...
        self.subHeadingLbl.text = self.getLocalizatioStringValue(key: "Wave your hand on the device’s screen. If your device is not able to detect the wave, cover the top part of your device with your palm")
