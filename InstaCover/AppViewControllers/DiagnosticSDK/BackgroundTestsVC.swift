...
class BackgroundTestsVC: UIViewController, CBCentralManagerDelegate, CLLocationManagerDelegate {
        ...
        if CLLocationManager.locationServicesEnabled() {
            if #available(iOS 14.0, *) {
                ...
                case .notDetermined, .restricted, .denied:
                    ...
                    locationManager.requestLocation(withDesiredAccuracy: .city, timeout: 10.0) { (currentLocation, achievedAccuracy, status) in
    ...
    @IBAction func startButtonPressed(_ sender: UIButton) {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.0) {
            ...
            if arrTestsInSDK.contains("gsm network") {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 2.0) {
            ...
            if arrTestsInSDK.contains("storage") {
        ...
        if arrTestsInSDK.contains("battery") {
