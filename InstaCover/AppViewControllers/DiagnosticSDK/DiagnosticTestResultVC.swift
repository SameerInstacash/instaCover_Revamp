...
class DiagnosticTestResultVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func setUIElementsProperties() {
        ...
        self.btnContinue.titleLabel?.font = UIFont.init(name: AppFontBold, size: fontSizeStart ?? 18.0)
    ...
    func createTableFromPassFailedTests() {
        ...
        if let val = AppUserDefaults.value(forKey: "GSM") as? Bool {
            ...
            if arrHoldTestsInSDK.contains("SMS Verification") {
        ...
        if arrFailedAndSkipedTest.count > 0 {
            if indexPath.section == 0 {
                ...
                if indexPath.row == 0 {
                    ...
                    cellFunction.imgReTry.image = #imageLiteral(resourceName: "greenCheck")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        arrTestsInSDK = arrHoldTestsInSDK
