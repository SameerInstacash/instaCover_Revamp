        ...
        DispatchQueue.main.async {
            ...
            if BioMetricAuthenticator.canAuthenticate() {
                ...
                if BioMetricAuthenticator.shared.faceIDAvailable() {
                    ...
                    self.testImgView.image = #imageLiteral(resourceName: "eye")
                    ...
                    self.subHeading1Lbl.font = UIFont.init(name: AppFontSemiBold, size: self.subHeading1Lbl.font.pointSize)
                    ...
                    self.subHeading2Lbl.font = UIFont.init(name: AppFontSemiBold, size: self.subHeading2Lbl.font.pointSize)
