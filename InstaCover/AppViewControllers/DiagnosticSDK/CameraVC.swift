...
class CameraVC: UIViewController {
    ...
    func setUIElementsProperties() {
        ...
        self.headingLbl.text = self.getLocalizatioStringValue(key: "Camera test")
        ...
        self.info1Lbl.font = UIFont.init(name: AppFontSemiBold, size: self.info1Lbl.font.pointSize)
        self.info2Lbl.text = self.getLocalizatioStringValue(key: "2. Press capture to take a shot!")
        self.info2Lbl.font = UIFont.init(name: AppFontSemiBold, size: self.info2Lbl.font.pointSize)
